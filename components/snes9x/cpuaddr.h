...
static inline uint16 RelativeSlow (AccessMode a)						// branch $xx
{
...
static inline uint16 Relative (AccessMode a)							// branch $xx
{
...
static inline uint16 RelativeLongSlow (AccessMode a)					// BRL $xxxx
{
...
static inline uint16 RelativeLong (AccessMode a)						// BRL $xxxx
{
...
static inline uint16 AbsoluteIndexedIndirectSlow (AccessMode a)			// (a,X)
{
	uint16	addr;
...
static inline uint16 AbsoluteIndexedIndirect (AccessMode a)				// (a,X)
{
...
static inline uint16 AbsoluteIndirectSlow (AccessMode a)				// (a)
{
	// No info on wrapping, but it doesn't matter anyway due to mirroring
...
static inline uint16 AbsoluteIndirect (AccessMode a)					// (a)
{
	// No info on wrapping, but it doesn't matter anyway due to mirroring
...
static inline uint16 DirectSlow (AccessMode a)							// d
{
...
static inline uint16 Direct (AccessMode a)								// d
{
...
static inline uint16 DirectIndexedXE0 (AccessMode a)					// d,X
{
...
static inline uint16 DirectIndexedXE1 (AccessMode a)					// d,X
{
	if (Registers.DL)
...
static inline uint16 DirectIndexedYSlow (AccessMode a)					// d,Y
{
	pair	addr;
	addr.W = DirectSlow(a);
	if (!CheckEmulation() || Registers.DL)
...
static inline uint16 DirectIndexedYE0 (AccessMode a)					// d,Y
{
...
static inline uint16 DirectIndexedYE1 (AccessMode a)					// d,Y
{
	if (Registers.DL)
...
static inline uint16 StackRelativeSlow (AccessMode a)					// d,S
{
...
static inline uint16 StackRelative (AccessMode a)						// d,S
{
